...
main( int argc, char *argv[ ] )
{
	...
	fclose( fp2 );
	size_t dataSize = Size*sizeof(cl_float);
	...
	cl_mem dArray = clCreateBuffer( context, CL_MEM_READ_ONLY, 2*dataSize, NULL, &status );
	if( status != CL_SUCCESS )
	...
	fprintf( stderr, "%8d\t%4d\t%10d\t%10.3lf MegaMultsPerSecond\n",
		SIZE, LOCAL_SIZE, NUM_WORK_GROUPS, (double)Size*Size/(time1-time0)/1000000. );
